...
from mmpose.structures.bbox import get_udp_warp_matrix, get_warp_matrix, get_affine_transform, warp_affine_joints
    ...
    def __call__(self, results):
        ...
        if self.use_udp:
            ...
            if not isinstance(img, list):
                ...
                img = [
                    cv2.warpAffine(i, trans, (int(image_size[0]), int(image_size[1])), flags=cv2.INTER_LINEAR)
                    for i in img
                ]
