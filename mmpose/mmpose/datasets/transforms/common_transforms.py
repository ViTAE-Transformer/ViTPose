...
from mmpose.parallel import DataContainer as DC
    ...
    def transform(self, results: Dict) -> Optional[dict]:
        ...
        if not isinstance(self.encoder, list):
            ...
            encoded = self.encoder.encode(
                keypoints=keypoints, keypoints_visible=keypoints_visible, **auxiliary_encode_kwargs
            )
            ...
            for _encoder in self.encoder:
                ...
                encoded_list.append(
                    _encoder.encode(keypoints=keypoints, keypoints_visible=keypoints_visible, **auxiliary_encode_kwargs)
                )
